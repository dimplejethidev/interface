...
function NavBar() {
    ...
    return (
        <div className={
            "fixed top-0 flex w-full text-aqueductBlue p-4 lg:px-8 lg:pt-6 lg:pb-4 z-50 backdrop-blur-3xl "
        ...
        >
            ...
            <div className={(isOpen ? 'flex flex-col space-y-4 pt-4' : 'hidden') + ' md:flex md:flex-row md:space-y-0 md:pt-0 md:space-x-3'}>
                <NavLink
        ...
        <div className="flex flex-col-reverse w-full md:w-2/3 md:flex-row p-4 md:p-0 justify-center" style={{ perspective: '80rem' }}>
            ...
            >
                <p className="lg:-rotate-y-sm" >
                    Watch your balances<br></br> change every second.
                </p >
            </div >
        </div >
    )
...
function DcaDisplay() {
    ...
    return (
        <div className="flex flex-col w-full p-4 space-y-4 md:p-0 md:space-y-0 md:w-2/3 md:flex-row " style={{ perspective: '80rem' }}>
            <div
                className="flex items-center justify-center text-white font-bold text-3xl bg-aqueductBlue p-16 rounded-3xl lg:rotate-y-md"
                style={{ perspective: '60rem' }}
            >
                <p className="lg:rotate-y-sm">
                    Avoid the chaos, <br></br> dollar cost average.
                </p>
            </div>
            <div className="bg-aqueductBlue/10 md:w-2/3 rounded-3xl p-16 pr-20 lg:-rotate-y-md" style={{ perspective: '60rem' }}>
                <svg
                    className="w-full h-full lg:-rotate-y-sm" viewBox="0 0 7000 4600"
                >
                    <path
                        ref={dummyRef}
                        d={points}
    ...
    return (
        <div className="flex flex-col w-full items-center space-y-0 text-slate-500 poppins-font">
            ...
            <div
                ...
                style={{ background: 'url(/background.gif) no-repeat center transparent', backgroundSize: 'cover' }}
            >
