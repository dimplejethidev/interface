...
> = ({ showToast }) => {
  ...
  const [currentRewardBalance0, setCurrentRewardBalance0] = useState<BigNumber>(
    ethers.BigNumber.from(0)
  );
  ...
  const [currentRewardBalance1, setCurrentRewardBalance1] = useState<BigNumber>(
    ethers.BigNumber.from(0)
  );
  ...
  async function refresh() {
    ...
    if (twapFlowRate.gt(0) && initialTwapBalance.gt(0)) {
      setAveragePrice(
        initialBalance0.mul(1000).div(initialTwapBalance).toNumber() / 1000
      );
    } else if (initialTwapBalance0.gt(0)) {
      setAveragePrice(
        initialBalance.mul(1000).div(initialTwapBalance0).toNumber() / 1000
      );
    }
        ...
        >
          ...
          {userAddress && token0 && token1 && (
            <div className="space-y-12 md:space-y-4">
              <WidgetContainer smallTitle="Total Amounts Streamed" isUnbounded>
                  ...
                  <div className="space-y-4">
                    {flowRate0.gt(0) && (
                      <BalanceField
                        ...
                        numDecimals={
                          19 -
                          flowRate0.toString().length -
                          (parseInt(flowRate0.toString()[0]) > 5 ? 1 : 0)
                        }
                        isLoading={isLoading}
                      />
                    )}
                    {flowRate1.gt(0) && (
                      <BalanceField
                        ...
                        numDecimals={
                          19 -
                          flowRate1.add(1000).toString().length -
                          (parseInt(flowRate1.toString()[0]) > 5 ? 1 : 0)
                        }
                        isLoading={isLoading}
                      />
                    )}
                    {twapFlowRate0.gt(0) && (
                      <BalanceField
                        ...
                        numDecimals={
                          19 -
                          twapFlowRate0.toString().length -
                          (parseInt(twapFlowRate0.toString()[0]) > 5 ? 1 : 0)
                        }
                        isLoading={isLoading}
                      />
                    )}
              ...
              {isTwap0 && isTwap1 ? (
                <div className="flex flex-col lg:flex-row space-y-12 md:space-y-4 lg:space-x-4 lg:space-y-0">
                  <RewardWidget
                    ...
                    numDecimals0={
                      19 -
                      rewardFlowRate0.add(1000).toString().length -
                      (parseInt(rewardFlowRate0.toString()[0]) > 5 ? 1 : 0)
                    }
                    numDecimals1={
                      19 -
                      rewardFlowRate1.add(1000).toString().length -
                      (parseInt(rewardFlowRate1.toString()[0]) > 5 ? 1 : 0)
                    }
                  />
                </div>
              ) : (
